...
Assuming you want to create a Geo-level table named MeridianData (you can change this name as needed) in a BigQuery Dataset, here is the DDL:

```sql
CREATE TABLE MeridianGeoData (
  geo STRING NOT NULL,
  time DATE NOT NULL,
...
For a National level table, here is the DDL:

```sql
CREATE TABLE MeridianNationalData (
  time DATE NOT NULL,
  Channel0_impression FLOAT64 NOT NULL,
  Channel1_impression FLOAT64 NOT NULL,
  Channel2_impression FLOAT64 NOT NULL,
